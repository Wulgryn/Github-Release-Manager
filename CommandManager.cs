...
namespace Github_Release_Manger
{
    internal class CommandManager
    {
        ...
        struct Pack
        {
            ...
            public Pack(string configPath)
            {
                ...
                if (File.Exists(path + "/build.version")) build_version = File.ReadAllText(path + "/build.version");
                else build_version = "No version file found.";
    ...
    internal enum Commands
    {
        ...
        [Description("Delete token.\n" +
            "\n{attr}'delete-token \"saved-name\" [-q:silent]'\n")]
        delete_token,
